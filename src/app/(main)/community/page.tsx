...
export default function CommunityPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-background">
      ...
      <h2 className="text-3xl font-display font-black text-text-primary mb-3 uppercase tracking-tighter">The Production Office</h2>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-xl">
        <div className="p-6 rounded-2xl bg-surface border border-border-default text-left group hover:bg-elevated transition-all cursor-pointer">
          <div className="w-10 h-10 rounded-xl bg-amber/10 flex items-center justify-center mb-4 text-amber font-bold">
            01
          </div>
          <h3 className="font-bold text-text-primary text-sm mb-1">Assemble Your Crew</h3>
        ...
        <div className="p-6 rounded-2xl bg-surface border border-border-default text-left group hover:bg-elevated transition-all cursor-pointer">
          ...
          <h3 className="font-bold text-text-primary text-sm mb-1">Sync & Screen</h3>
      ...
      <div className="mt-12 pt-8 border-t border-border-default w-full max-w-xl flex justify-between items-center px-4">
        <div className="flex flex-col items-start">
          <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Active Rooms</span>
          <span className="text-lg font-display font-bold text-text-primary">4,281</span>
        </div>
